...
function accesoAdmin() {
    const clave = prompt("Acceso Restringido - Clave:");
    if (clave === "LITA2026") {
...
async function enviarReporte() {
    ...
    navigator.geolocation.getCurrentPosition(async (pos) => {
        ...
        else { alert("✅ Reporte enviado al GAD con éxito"); location.reload(); }
    }, () => {
        alert("Error: Active el GPS de su dispositivo");
...
async function cargarReportes() {
    ...
    lista.innerHTML = "<tr><td colspan='6' style='text-align:center;'>Cargando información...</td></tr>";
